    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-3">
                ...
                <form class="mx-4 my-4" action="/guru" method="POST" role="form text-left">
                    @csrf
                    <div class="mb-3">
                      <label for="nama" class="form-label">Nama Guru <span class="text-danger">*</span></label>
                      <input type="text" class="form-control" name="nama" id="nama" required placeholder="Masukkan Nama Guru">
                    </div>
                    <div class="mb-3">
